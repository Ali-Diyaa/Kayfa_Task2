...
if not df_q1.empty:
    ...
    fig.update_layout(height=340, yaxis_title="Attendance %")
    pfig(fig)
...
# Q4
st.markdown('<div class="section-card"><div class="section-title">Q4 – Attendance → Grade</div></div>', unsafe_allow_html=True)
if not pts.empty:
...
if not df_q15.empty:
    ...
    fig.update_layout(height=340, xaxis_title="Assessment Sequence", yaxis_title="Avg Score")
    pfig(fig)
